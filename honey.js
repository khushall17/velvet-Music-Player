const music = new Audio('audio/atif/1.mp3');
//music.play();
...
const songs = [
    {
        ...
        poster: "img/honey_img/1.jpeg"
    },
    {
        id: 2,
        songName: `Birthday Bash <br>
        <div class = "subtitle">Honey Singh</div>`,
        poster: "img/honey_img/2.jpeg",
    ...
    },
    {
        ...
        <div class = "subtitle">Honey Singh</div>`,
        poster: "img/honey_img/3.jpeg",
    },
    {
        id: 4,
        songName: `Kalaastar <br>
        <div class = "subtitle">Honey Singh</div>`,
        poster: "img/honey_img/4.jpeg",
    },
    {
        id: 5,
        songName: `Lungi Dance <br>
        <div class = "subtitle">Honey Singh</div>`,
        poster: "img/honey_img/5.jpeg",
    },
    {
        id: 6,
        songName: `Sunny Sunny <br>
        <div class = "subtitle">Honey Singh</div>`,
        poster: "img/honey_img/6.jpeg",
    },
     {
         id: 7,
         songName: `Angreji Beat <br>
         <div class = "subtitle">Honey Singh</div>`,
         poster: "img/honey_img/7.jpeg",
     },
     {
        id: 8,
        songName: `Chaar Botal Vodka <br>
        <div class = "subtitle">Honey Singh</div>`,
        poster: "img/honey_img/8.jpeg"
    },
     {
         id: 9,
         songName: `First Kiss <br>
        <div class = "subtitle">Honey Singh</div>`,
         poster: "img/honey_img/9.jpeg"
     },
     {
        id: 10,
        songName: `Party All Night <br>
        <div class = "subtitle">Honey Singh</div>`,
        poster: "img/honey_img/10.jpeg"
    },
    {
        id: 11,
        songName: `Makhna <br>
        <div class = "subtitle">Honey Singh</div>`,
        poster: "img/honey_img/11.jpeg"
    },
    {
        id: 12,
        songName: `Blue Eyes <br>
        <div class = "subtitle">Honey Singh</div>`,
        poster: "img/honey_img/12.jpeg"
    },
    {
        id: 13,
        songName: `Loca <br>
        <div class = "subtitle">Honey Singh</div>`,
        poster: "img/honey_img/13.jpeg"
    },
    {
        id: 14,
        songName: `One Bottle Down<br>
        <div class = "subtitle">Honey Singh</div>`,
        poster: "img/honey_img/14.jpeg"
    },
    {
        id: 15,
        songName: `This Party Is Over Now<br>
        <div class = "subtitle">Honey Singh</div>`,
        poster: "img/honey_img/15.jpeg"
    },
...
Array.from(document.getElementsByClassName('playListPlay')).forEach((e) => {
    e.addEventListener('click', (el) => {
        index = el.target.id;
        music.src = `audio/honey/${index}.mp3`;
        //poster_master_play.src = `img/${index}jpeg`;
        music.play();
        masterPlay.classList.remove('bi-play-fill');
        masterPlay.classList.add('bi-pause-fill');
        download_music.href = `audio/honey/${index}.mp3`;
